                      ...
                      top: 0;
                        ...
                        .sticky + .content {
                          ...
                          <div align="center" class="sticky" id="myHeader222">
                           ...
                           <div style="width:500px;height:40px;border:0px solid #000;">This is a rectangle!</div>
                           <title>W3.CSS</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
...
<p>
  ...
  <button onclick='changeSrc()3' class="w3-btn w3-ripple w3-yellow">Completed Repairs</button>
    ...
    <button class="w3-btn w3-ripple w3-grey" type="submit">Search</button>
                               ...
                               ?>
                                   <tr>
                                     ...
                                     <td><?php echo $rows['LiftType']; ?></td>
                                     <td><?php echo $rows['Cerial']; ?></td>
