                      ...
                      top: 0;
                        ...
                        .sticky + .content {
                          ...
                          <div align="center" class="sticky" id="myHeader222">
                            <h2>Edit Registerd Lifts<h2>
                            </div>

                           <div style="width:500px;height:20px;border:0px solid #000;"></div>
                           ...
                           <div>
                               <table id="editable_table" class="table table-bordered table-striped">
                                ...
                                <div class="search-container">
                                  ...
                                  <button onclick='changeSrc()' class="w3-btn w3-ripple w3-black">Registerd Registerd Lifts</button>
                                  <button onclick='changeSrc()' class="w3-btn w3-ripple w3-yellow">Edit Registerd Lifts</button>
                                </div>
                            ...
                            <script>
                                $(document).ready(function(){
                                   $('#editable_table').Tabledit({
                                    ...
                                    columns:{
                                     identifier:[0, "id"],
                                     editable:[[1, 'Bay'], [2, 'Brand'], [3, 'Capacity'], [4, 'LiftType'], [5, 'Seria;'], [6, 'Notes']]
                                    },
                                    restoreButton:false,
